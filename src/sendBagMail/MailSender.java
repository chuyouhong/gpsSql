...
public class MailSender {
    ...
    public MailInfo getMailInfo() {
        ...
        info.setUsername("222@medishare.cn");
        info.setPassword("222123456");
        info.setNotifyTo("22981@qq.com");
        info.setNotifyCc("aa2981aa@163.com");
        info.setSubject("java send mail test");
        info.setContent("中文编码测试，看是不是乱码");
        info.setAttachFileNames(new String[]{"src/sendBagMail/11.jpg", "2.jpg","UpdateHospitalFile.txt"});//添加附件
        return info;
    }
}